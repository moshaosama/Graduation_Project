...
const DoctorsSec = () => {
  ...
  // const DetailsRender = (Specialty_name: string) => {
  //   return (
  //     <>
    ...
    <>
      <div className="my-4">
        <h1 className="text-md text-gray-700 font-bold">
          {Doctors?.result?.length} Doctors
        </h1>
        {Doctors?.result?.map((el: any) => {
          return (
            <>
              <div className="bg-white w-full p-5 rounded-xl shadow-md flex flex-col my-4 hover:bg-gray-300 cursor-pointer  transition-all duration-300">
