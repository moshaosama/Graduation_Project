...
function Home() {
  useEffect(() => {
    ...
    if (HeaderText) {
      HeaderText.style.setProperty("max-sm:top", "0");
    ...
    <>
      <div className="relative">
        ...
        <div className="bg-white max-sm:px-3 max-sm:py-6 flex flex-col gap-5 ">
          <div
            className="absolute max-sm:relative top-28 max-sm:top-10 opacity-15 transition-all duration-1000 left-80 max-sm:left-0 flex flex-col gap-3 text-black"
            id="HeaderText"
          >
